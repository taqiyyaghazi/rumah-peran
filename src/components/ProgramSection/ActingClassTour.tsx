...
const contents = [
  {
    id: 1,
    text: 'Belajar skill akting dasar & lanjutan (12x pertemuan).',
  ...
  {
    id: 3,
    text: 'Meningkatkan kepercayaan diri.',
    image: '/holistic-icon.svg',
  },
  {
    id: 4,
    text: 'Terhubung langsung dengan industri entertainment indonesia.',
    image: '/holistic-icon.svg',
  },
  {
    id: 5,
    text: 'Tips dan wawasan praktikal mengenai dunia entertainment di Indonesia.',
    image: '/holistic-icon.svg',
  },
];
    ...
    <div>
      ...
      <div>
        ...
        <div className='flex max-sm:flex-col md:flex-wrap items-center gap-4'>
          {schedules.map(({ id, city, month, location, price, image }) => (
            <div key={id} className="flex flex-col justify-end p-4 text-white w-48 aspect-[3/4] rounded-xl relative overflow-hidden">
              <div className="absolute inset-0 bg-black/30 -z-10"></div>
              <Image src={image} alt={city} fill className='object-cover -z-20' />
              <div></div>
              <div>
                <p
                ...
                <div className="flex items-center gap-x-2 mb-2">
                  ...
                  <p className={`${inter.className} text-xs md:text-sm`}>{month}</p>
                </div>
                <div className="flex items-center gap-x-2 mb-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className={`${inter.className} text-xs md:text-sm`}>{location}</p>
                </div>
                <div className="flex items-center gap-x-2 mb-2">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <p className={`${inter.className} text-xs md:text-sm`}>{price}</p>
                </div>
              </div>
            </div>
          ))}
